...
export const ANOMALIES = [
  ...
  // Classic
  { id: 'please_stand_by',    duration: 4200, type: 'overlay' },
  { id: 'no_signal',          duration: 3600, type: 'overlay' },
  { id: 'landing_flash',      duration: 1800, type: 'overlay' },
  { id: 'dead_frequency',     duration: 5000, type: 'overlay' },
  { id: 'channel_zero',       duration: 4000, type: 'overlay' },
  { id: 'color_bars_glitch',  duration: 3000, type: 'overlay' },
  { id: 'memory_corruption',  duration: 3500, type: 'overlay' },
  { id: 'broadcast_warning',  duration: 5500, type: 'overlay' },

  // API-powered
  { id: 'system_message',     duration: 4500, type: 'overlay', needsApi: true },
  { id: 'ascii_face',         duration: 3800, type: 'overlay', needsApi: true },
  { id: 'static_gif',         duration: 4200, type: 'overlay', needsApi: true },
  { id: 'eerie_gif',          duration: 5000, type: 'overlay', needsApi: true },
  { id: 'late_night_joke',    duration: 6000, type: 'overlay', needsApi: true },
  { id: 'cryptic_fact',       duration: 5500, type: 'overlay', needsApi: true },
  { id: 'unsolicited_advice', duration: 5000, type: 'overlay', needsApi: true },
  { id: 'weather_intercept',  duration: 5500, type: 'overlay', needsApi: true },
  { id: 'number_transmission',duration: 4800, type: 'overlay', needsApi: true },

  // New creative overlays
  { id: 'viewer_count',       duration: 4000, type: 'overlay' },
  { id: 'signal_decoded',     duration: 5000, type: 'overlay' },
  { id: 'static_poem',        duration: 6000, type: 'overlay' },
  { id: 'lost_transmission',  duration: 5500, type: 'overlay' },
  { id: 'countdown',          duration: 5000, type: 'overlay' },
  { id: 'mirror_test',        duration: 4500, type: 'overlay' },
  { id: 'classified_footage', duration: 4000, type: 'overlay' },
  { id: 'time_glitch',        duration: 3800, type: 'overlay' },
  { id: 'morse_code',         duration: 5200, type: 'overlay' },
  { id: 'pixel_eyes',         duration: 4200, type: 'overlay' },
]
